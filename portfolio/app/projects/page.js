...
const Projects = () => {
    return (
        <div id='projects' className='p-4 md:px-8 mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  space-x-4 space-y-4  '>
            <ProjectsCard img={attendance} title="Attendance Menegement app" gitlink="https://github.com/Mashoodgondal/Students-attendance.git" prelink="students-attendance-hnyw.vercel.app" />
