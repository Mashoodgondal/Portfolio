                    ...
                    <div className="flex space-x-4">
                        ...
                        {proops.gitlink && (
                            <a
                                ...
                                className="bg-white p-3 rounded-full shadow-lg hover:bg-purple-500 hover:text-white transition-colors duration-300"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="none"
                        ...
                        {proops.prelink && (
                            <a
                                href={`https://${proops.prelink}`}
                                target="_blank"
                                rel="noopener noreferrer"
                                className="bg-white p-3 rounded-full shadow-lg hover:bg-blue-500 hover:text-white transition-colors duration-300"
                            >
                                <svg
                                    className="w-6 h-6"
                                    fill="none"
